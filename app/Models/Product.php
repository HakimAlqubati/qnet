...
class Product extends Model implements Orderable, HasMedia
{
    use HasFactory;
    use IsTenantModel;
    ...
    {
        return $this->featured_image ?? url('/') . '/storage/logo/full_qnet_logo_image.png';
        // return asset(Storage::url($this->featured_image));
    }

    public function getFeatredImageAttribute()
    {
        return url('/') . '/storage/logo/full_qnet_logo_image.png';
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($product) {
            ...
            if (empty($product->long_description)) {
                $product->long_description = Str::limit($product->description, 100);
            }
        });
    }
}
